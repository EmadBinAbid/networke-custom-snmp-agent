...
EnterpriseNumber::EnterpriseNumber() : InformationNode()
{}

EnterpriseNumber::EnterpriseNumber(string _nodeId, string _parentId, string _treeId, string _nodeType, string _nodeValue) 
...
string EnterpriseNumber::toString()
{
